...
public class InstantiatePrefabs : MonoBehaviour {
    ...
    public ConductivityGloves ConGloves;
	...
	void Update () {
        if (Input.GetKeyDown(KeyCode.Plus) || Input.GetKeyDown(KeyCode.KeypadPlus) || ConGloves.Conductive > 0.2f) {
            AddPrefab();
        }
        ...
        if (Input.GetKeyDown(KeyCode.Minus) || Input.GetKeyDown(KeyCode.KeypadMinus) || ConGloves.Conductive == 0) {
